...
export function FormAddImage({ closeModal }: FormAddImageProps): JSX.Element {
  ...
  const formValidations = {
    image: {
      ...
      validate: {
        lessThan10MB: (fileList: FileListProps) => 
          fileList[0].size < 10000000 || 'O arquivo precisa ser menor que 10mb.',
        acceptedFormats: (fileList: FileListProps) =>
          acceptedFormatsRegex.test(fileList[0].type) ||
          'Apenas são aceitados arquivos .png, .jpeg ou .gif'
      },
    },
    title: {
